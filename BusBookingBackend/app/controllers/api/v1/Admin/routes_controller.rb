  ...
  module V1
    module Admin
      class RoutesController < BaseController
        ...
        def index
          result = Route::Index.call(current_user: current_user)
        ...
        def show
          result = Route::Show.call(params: params, current_user: current_user)
        ...
        def destroy
          result = Route::Destroy.call(params: params, current_user: current_user)
